...
print("Ejercicio 2")
nota_obtenida=int(input("Ingrese su nota: "))
...
if hemisferio == "N":
    if (mes == 12 and dia >= 21) or (mes <= 3 and mes >= 1) or (mes == 3 and dia <= 20):
        print("Verano")
    elif (mes == 3 and dia >= 21) or (mes <= 6 and mes >= 4) or (mes == 6 and dia <= 20):
        print("Primavera")
    elif (mes == 6 and dia >= 21) or (mes <= 9 and mes >= 7) or (mes == 9 and dia <= 20):
        print("Otoño")
    elif (mes == 9 and dia >= 21) or (mes <= 12 and mes >= 10) or (mes == 12 and dia <= 20):
        print("Invierno")
    else:
